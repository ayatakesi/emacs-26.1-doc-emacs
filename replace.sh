...
's/\@subsection Appointments$/\@subsection アポイントメント/;'\
...
's/\@subsection Copyright Assignment$/\@subsection 著作権の割り当て/;' -i trouble-ja.texi
perl -pe \
...
's/\@appendixsubsec GTK styles$/\@appendixsubsec GTKスタイル/;'\
's/\@appendixsec GTK\+ resources$/\@appendixsec GTK+リソース/;'\
's/\@appendixsubsec GTK\+ widget names$/\@appendixsubsec GTK+ウィジェット名/;'\
's/\@appendixsubsec GTK\+ styles$/\@appendixsubsec GTK+スタイル/;' -i xresources-ja.texi
perl -pe \
